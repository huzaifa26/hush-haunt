...
export default function ProfileEdit({}: Props) {
  return (
    <div className='w-[38.38616714697406vw] ml-[7.3198847262247835vw]'>
        ...
        <div className='flex flex-col justify-center gap-[10px] items-center mt-[18px] w-[22.59365994236311vw] h-[336px] bg-[#F5F5F5] rounded-[10px]'>
        ...
        <input className='indent-[28px] mt-[102px] font-[400] text-[16px] leading-[26.06px] text-[#231414D4] border-[1px] border-[#231414D4] w-full h-[68px]' placeholder='Organisation name'/>
        <select className='indent-[28px] mt-[102px] mb-[39px] font-[400] text-[16px] leading-[26.06px] text-[#231414D4] border-[1px] border-[#231414D4] w-full h-[68px]'>
