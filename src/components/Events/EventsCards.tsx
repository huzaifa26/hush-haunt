    ...
    return (
        <div className='m-auto w-[86.1671469740634vw]'>
            <div className='flex justify-between'>
                ...
                <motion.button initial={{ scale: 1, backgroundColor: '#ffffff00' }} whileHover={{ scale: 1.02, backgroundColor: "#FB4A04",color:"#fff" }} className='w-[9.855907780979827vw] min-w-[120px] h-[53px] border-2 border-[#FB4A04] font-[400] text-[clamp(16px,1.38328530259366vw,24px)] leading-[40px] text-[#473a3a]'>See More</motion.button>
            </div>
