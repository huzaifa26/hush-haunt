    ...
    return (
        <div>
            ...
            <div className='w-[42.70893371757925vw] m-auto'>
                <h3 className='font-[700] text-[24px] leading-[39px] text-[#473a3a] ml-[3%] mt-[85px]'>Orders</h3>
                <div className='flex flex-col items-center'>
                    <h3 className='font-[700] text-[24px] leading-[39px] text-[#473a3a] mb-[13px]'>Looking for your tickets?</h3>
                    <p className='font-[400] text-[20px] leading-[33px] text-[#473a3a] mb-[36px]'>You need to verify your email to view transfers and gifts.</p>
                    ...
                    <p className='font-[400] text-[20px] leading-[33px] text-[#473a3a] mb-[36px]'>No upcoming order</p>
                </div>
