        ...
        <div>
            ...
            <section className='relative top-0 w-full h-[219px]'>
                ...
                <div className='relative z-20'>
                    <h1 className='font-[700] text-[clamp(20px,2.07492795389049vw,36px)] leading-[58px] text-[#fff] mt-[102px] mb-[52px] text-center'>Partymode livestreams and videos on demand </h1>
                </div>
            </section>
            ...
            <section className='w-[86vw] m-auto flex pt-[86px]'>
                <div className='flex-1'>
                    ...
                    <h2 className='font-[700] text-[clamp(16px,1.38328530259366vw,24px)] leading-[39px] text-[#473a3a] w-[35.04322766570605vw] mb-[17px]'>How do I access my livestreams and videos on demand?</h2>
                    <h3 className='font-[400] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26px] text-[#473a3a] h-[40px]'>Modified on: Thu, Jan 14, 2021 at 4:36 PM</h3>
                ...
                <div className='flex-1'>
                    ...
                    <div className='mt-[17px] flex flex-col gap-[5px]'>
                        <div className='flex items-center gap-[9px]'>
                            ...
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>How much does it cost to use  Partymode to sell tickets?</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Does Partymode support international events?</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>I see a lot of music events on Partymode. Do you support any other artist?</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Early releases and gated content.</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>How do you log in to Partymode ?</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Can I take a look around the system with a trial username and password</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Frequently asked questions about the live stream experience</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Streaming Recommendations</p>
                        </div>
                        <div className='flex items-center gap-[9px]'>
                            <img src='darkCircle.png' alt='' />
                            <p className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[32px] text-[#473a3a] h-[43px]'>Troubleshooting Guide</p>
                        </div>
                    </div>
                </div>
            </section>
