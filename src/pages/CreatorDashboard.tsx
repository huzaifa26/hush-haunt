            ...
            <div className='w-full pt-[65px] ml-[12.968299711815561vw]'>
                ...
                <div className='border-2 border-[#D9D9D9] rounded-tl-[20px] rounded-tr-[20px] w-[52.04610951008645vw] px-[21px] divide-y-2 mt-[99px]'>
                    ...
                    <div className='flex justify-between px-[17px] py-[30px]'>
                        <h3 className='font-[700] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[12px]'>Create your first event</h3>
                        <img src='./dropdown.svg' />
                    </div>
                    <div className='flex justify-between px-[17px] py-[30px]'>
                        <h3 className='font-[700] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[12px]'>Build your profile</h3>
                        <img src='./dropdown.svg' />
                    </div>
                    <div className='flex justify-between px-[17px] py-[30px]'>
                        <h3 className='font-[700] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[12px]'>Boost Your Event</h3>
                        <img src='./dropdown.svg' />
                    </div>
                    <div className='flex justify-between px-[17px] py-[30px]'>
                        <h3 className='font-[700] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[12px]'>Set up your finances</h3>
                        <img src='./dropdown.svg' />
                    </div>
                </div>
                ...
                <div className='w-[52.04610951008645vw] border-2 border-[#D9D9D9] mt-[70px] flex flex-col'>
                    ...
                    <div className='w-full h-[71px] bg-[#fee4d9] flex items-center justify-between pl-[39px] pr-[100px]'>
                        <h3 className='font-[700] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[12px]'>Nov 18</h3>
                ...
                <div className='w-[52.04610951008645vw] border-2 border-[#D9D9D9] mt-[70px] flex flex-col'>
                    <h2 className='font-[700] text-[clamp(16px,1.38328530259366vw,24px)] leading-[39px] text-[#473a3a] mt-[8px] ml-[33px]'>Boost your Events with Vibe Check</h2>
                    <p className='font-[400] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mt-[25px] ml-[33px]'>Take your marketing to the next level</p>
