...
export default function Events({ }: Props) {
    ...
    return (
        <div className='w-[calc(100vw - 100%)]'>
            <nav className='flex justify-between items-center w-[100%] xsm:flex-col'>
            ...
            <section className='eventsMainBackground h-[778px] w-[100%] flex relative'>
                <div className='flex flex-col justify-center absolute top-[39%] left-[65.24495677233429vw] xsm:left-[10vw] sm:left-[50vw]'>
                    ...
                    <Button initial={{ scale: 1, backgroundColor: '#FB4A04',color:"#fff" }} whileHover={{ scale: 1.02, backgroundColor: "#ffffff00",border:"3px solid #FB4A04",color:"#FB4A04" }} width={"17.75vw"} height={"61px"} text={"Find your next Event"} style={{minWidth:"240px"}}/>
                </div>
            </section>
