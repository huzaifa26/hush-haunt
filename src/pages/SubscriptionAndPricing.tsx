            ...
            <div className='relative top-[92px]'>
                ...
                <section className='w-full bg-[#ffe7de]'>
                    ...
                    <div className='flex justify-between items-center w-[86vw] m-auto mt-[0px] xsm:w-full sm:w-full md:w-[95%] xsm:flex-col sm:flex-col md:flex-col pb-[92px]'>
                        <motion.div whileHover={{scale:1.03}} className='xsm:rounded-[50px] sm:rounded-[50px] md:rounded-[50px] w-[27.838616714697405vw] xsm:min-w-[90vw] sm:min-w-[60vw] h-[582px] bg-white rounded-tr-[50px] rounded-br-[50px] overflow-hidden min-w-[280px]'>
                        ...
                        <motion.div whileHover={{scale:1.03}} className='w-[27.738616714697405vw] xsm:min-w-[92vw] sm:min-w-[62vw] mb-[20px] h-[724px] xsm:mb-[50px] sm:mb-[50px] md:mb-[50px] bg-white rounded-[50px] overflow-hidden min-w-[280px] mt-[50px]'>
                        ...
                        <motion.div whileHover={{scale:1.03}} className='w-[27.838616714697405vw] xsm:min-w-[90vw] sm:min-w-[60vw] h-[582px]  bg-white xsm:rounded-[50px] sm:rounded-[50px] md:rounded-[50px] rounded-tl-[50px] rounded-bl-[50px] overflow-hidden min-w-[280px]'>
                            <div className='w-full h-[109px] bg-[#473a3a] flex justify-center items-center'>
                                <div className='relative flex items-center'>
                ...
                <section className='w-[86vw] flex m-auto mt-[97px] xsm:flex-col sm:flex-col md:flex-col'>
                    <div className='flex-2 flex flex-col'>
                        ...
                        <img className='' src='./rafiki.png' alt=''></img>
                    </div>
